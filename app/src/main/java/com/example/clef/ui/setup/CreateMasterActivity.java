...
public class CreateMasterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextWatcher watcher = new TextWatcher() {
            ...
            @Override public void afterTextChanged(Editable s) { updateStrengthUi(); clearErrorsIfPossible(); }
        };
            ...
            try {
                ...
                repo.registerUser(bundle, new VaultRepository.Callback<Void>() {
                    ...
                    @Override public void onError(Exception e) {
                        mainHandler.post(() -> {
                            setLoading(false);
                            Toast.makeText(CreateMasterActivity.this, R.string.master_error_register_failed, Toast.LENGTH_LONG).show();
                        });
                    }
                });
            } catch (Exception e) {
                mainHandler.post(() -> {
                    setLoading(false);
                    Toast.makeText(this, R.string.master_error_crypto_failed, Toast.LENGTH_LONG).show();
                    if (e.getMessage() != null && e.getMessage().toLowerCase(Locale.ROOT).contains("auth")) {
